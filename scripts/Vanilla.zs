...
recipes.addShaped(bucket * 1, [[<ore:plateIron>,null,<ore:plateIron>], [null,<ore:plateIron>,null]]);
bucket.addTooltip(format.white("Use clay buckets until you can make iron plates."));
